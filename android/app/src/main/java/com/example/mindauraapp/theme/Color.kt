...
val md_theme_dark_secondaryContainer = Color(0xFF4F3689)
val md_theme_dark_onSecondaryContainer = Color(0xFFE9DDFF)
val md_theme_dark_tertiary = Color(0xFF6CDBAB)
...
// Custom Colors for Glassmorphism & Gradients
val GlassBackgroundLight = Color(0xFFFFFFFF).copy(alpha = 0.6f)
val GlassBackgroundDark = Color(0xFF191C1E).copy(alpha = 0.6f)
val GradientStart = Color(0xFF00668A)
val GradientEnd = Color(0xFF684FA3)
